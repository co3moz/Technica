...
namespace Technica.DAL
{
    public class TechnicaInitializer : DropCreateDatabaseIfModelChanges<TechnicaContext>
    {
        ...
        protected override void Seed(TechnicaContext context)
        {
            ...
            context.Products.Add(new Product { CategoryID = 2, Name = "IPHONE 5S 16 GB", Price = 1749m, Image = "product/SAMSUNGI9060.jpg" });
            ...
            context.Products.Add(new Product { CategoryID = 3, Name = "HP 15-R103NT ", Price = 1648m, Image = "HP 15-R103NT.jpg" });
            ...
            context.Products.Add(new Product { CategoryID = 3, Name = "HP 15-R113NT ", Price = 1699m, Image = "product/HP 15-R113NT.jpg.jpg" });
